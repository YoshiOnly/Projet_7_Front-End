    ...
    <div>    
        ...
        <main class="row justify-content-center">
            <div class="col-10">
                ...
                <div class="col-12">
                    <h1 class="" style="">Vous consultez vote compte</h1>
                ...
                <section id="filPrincipal" class="row">
                    <div class="col-12">
                        ...
                        <div class="card" style="float:none;">
                            ...
                            <div class="card-body">
                                <div class="btn rounded p-3"><button><span class="m-3 font-weight-bold">Depuis cette page vous pouvez supprimer votre compte. La suppression de votre compte entrainera également la suppression de tous les commentaires et les images que vous avez posté.</span></button></div>
                            </div>
                            <div class="card-body">
                                <div class="btn rounded p-3" style="cursor:default"><button @click="deleteMyAccount(id)" class="rounded p-2"> Suppression du compte</button></div>
                            </div>
                        </div> 
                    </div>  
                </section>
